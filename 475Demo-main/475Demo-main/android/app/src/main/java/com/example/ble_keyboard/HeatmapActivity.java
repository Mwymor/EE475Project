...
public class HeatmapActivity extends BaseDemoActivity {
    ...
    protected void startDemo(boolean isRestore) {
        if (!isRestore) {
            getMap().moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(46, -122), 4));
        }
        ...
        try {
            mLists.put(getString(R.string.Wellas), new DataSet(readItems(R.raw.police),
                    getString(R.string.Wellas_url)));
        ...
        public void onItemSelected(AdapterView<?> parent, View view,
            ...
            if (mProvider == null) {
                mProvider = new HeatmapTileProvider.Builder().data(
                        mLists.get(getString(R.string.Wellas)).getData()).build();
